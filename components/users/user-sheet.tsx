                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 px-1">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            className="h-10 rounded-xl font-mono text-left focus-visible:ring-primary/20" dir="ltr"
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <Input
                                ...
                                className="h-10 rounded-xl pe-10 focus-visible:ring-primary/20"
                                {...register("password", {
                    ...
                    {/* Sticky Submit */}
                    <div className="sticky bottom-0 left-0 right-0 z-10 pt-4 bg-background border-t border-border/50 pb-4 mt-6">
                        <Button 
                            type="submit" 
                            disabled={isLoading} 
                            className="w-full h-11 bg-linear-to-l from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-primary-foreground shadow-md transition-all duration-300 gap-2"
                        >
