...
interface ClientPaginationProps<TData> {
            ...
            <div className="flex-1 text-sm text-muted-foreground">
                <div className="flex items-center gap-6">
                    ...
                    <span className="hidden sm:inline-block">
                        إجمالي العناصر: <span className="font-bold text-foreground">{(totalCount ?? dataLength).toLocaleString("ar-EG")}</span>
                    </span>
                </div>
            </div>
            <div className="flex items-center gap-4 sm:gap-6 lg:gap-8 text-sm">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        disabled={!table.getCanPreviousPage()}
                    >
                        <span className="sr-only">السابقة</span>
                    ...
                    >
                        <span className="sr-only">التالية</span>
