...
export const columns: ColumnDef<ProductAttribute>[] = [
    {
        accessorKey: "code",
    ...
    },
    {
        accessorKey: "name",
        enableColumnFilter: true,
        meta: { filterType: 'text' as const, filterPlaceholder: 'اسم الصفة...' },
        header: () => <div className="text-start pe-0">الصفة</div>,
        cell: ({ row }) => (
                ...
                <>
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                                onClick={() => {
                                    const event = new CustomEvent("edit-product-attribute", {
                                        detail: attribute,
                                    })
                    ...
                    <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    سيتم حذف الصفة &quot;{attribute.name}&quot; بشكل نهائي.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
